...
def editSettings()
  system(Ffmpeg_path + 'ffmpeg -show_video_device_dialog true -f dshow -i video="Osprey-827e MFI Video Device 1" -t 0.1 -f null -')
end
